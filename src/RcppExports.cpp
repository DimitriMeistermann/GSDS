...
RcppExport SEXP _GSDS_aurocCPP(SEXP scoreSEXP, SEXP boolVectSEXP, SEXP n1SEXP, SEXP n2SEXP) {
BEGIN_RCPP
...
RcppExport SEXP _GSDS_pvalLmFit(SEXP residualsSEXP, SEXP coefficientsSEXP, SEXP pSEXP, SEXP qrSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_GSDS_aurocCPP", (DL_FUNC) &_GSDS_aurocCPP, 4},
    {"_GSDS_pvalLmFit", (DL_FUNC) &_GSDS_pvalLmFit, 4},
    {NULL, NULL, 0}
};

RcppExport void R_init_GSDS(DllInfo *dll) {
